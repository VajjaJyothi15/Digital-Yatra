...
def seed_database():
    ...
    guides = [
        ...
        # user_id 6: Anand Verma (Varanasi)
    ...
    conn.commit()
    conn.close()
    print("[SUCCESS] Database seeded cleanly with multi-city Indian destinations, local guides, and services!")
